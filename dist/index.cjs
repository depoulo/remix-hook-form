...
var require_production = __commonJS({
  "node_modules/react-router/dist/production/index.js"(exports, module2) {
    "use strict";
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
    ...
    var React10 = __toESM2(require("react"));
    ...
    var React9 = __toESM2(require("react"));
    ...
    function getKeyedLinksForMatches(matches, routeModules, manifest) {
      let descriptors = matches.map((match) => {
        ...
        return [
          ...
          ((_a = module22 == null ? void 0 : module22.links) == null ? void 0 : _a.call(module22)) || []
        ];
      }).flat(2);
    ...
    var React8 = __toESM2(require("react"));
    var React7 = __toESM2(require("react"));
    ...
    var React6 = __toESM2(require("react"));
...
import(${JSON.stringify(manifest.entry.module)});`;
    ...
    var React11 = __toESM2(require("react"));
    ...
    var React12 = __toESM2(require("react"));
